...
export function adicionarDadosPadrao(clientes: Array<Cliente>, produtos: Array<Produto>, servicos: Array<Servico>, pets: Array<Pet>, historico: Array<Historico>) {
    ...
    let historico1 = new Historico(1, clientes[0], produtos[0].getNome, pets[0], produtos[0].getValor, "01/01/2022", "10:00", "produto");
    historico.push(historico1);
    let historico2 = new Historico(2, clientes[1], produtos[1].getNome, pets[1], produtos[1].getValor, "02/01/2022", "11:00", "produto");
    historico.push(historico2);
    let historico3 = new Historico(3, clientes[2], produtos[2].getNome, pets[2], produtos[2].getValor, "03/01/2022", "12:00", "produto");
    historico.push(historico3);
    let historico4 = new Historico(4, clientes[3], produtos[3].getNome, pets[3], produtos[3].getValor, "04/01/2022", "13:00", "produto");
    historico.push(historico4);
    let historico5 = new Historico(5, clientes[4], produtos[4].getNome, pets[4], produtos[4].getValor, "05/01/2022", "14:00", "produto");
    historico.push(historico5);
    let historico6 = new Historico(6, clientes[5], produtos[5].getNome, pets[5], produtos[5].getValor, "06/01/2022", "15:00", "produto");
    historico.push(historico6);
    let historico7 = new Historico(7, clientes[6], produtos[6].getNome, pets[6], produtos[6].getValor, "07/01/2022", "16:00", "produto");
    historico.push(historico7);
    let historico8 = new Historico(8, clientes[7], produtos[7].getNome, pets[7], produtos[7].getValor, "08/01/2022", "17:00", "produto");
    historico.push(historico8);
    let historico9 = new Historico(9, clientes[8], produtos[8].getNome, pets[8], produtos[8].getValor, "09/01/2022", "18:00", "produto");
    historico.push(historico9);
    let historico10 = new Historico(10, clientes[9], produtos[9].getNome, pets[9], produtos[9].getValor, "10/01/2022", "19:00", "produto");
    historico.push(historico10);
    let historico11 = new Historico(11, clientes[10], produtos[10].getNome, pets[10], produtos[10].getValor, "11/01/2022", "20:00", "produto");
    historico.push(historico11);
    let historico12 = new Historico(12, clientes[11], produtos[11].getNome, pets[11], produtos[11].getValor, "12/01/2022", "21:00", "produto");
    historico.push(historico12);
    let historico13 = new Historico(13, clientes[2], produtos[0].getNome, pets[2], produtos[0].getValor, "21/01/2022", "16:00", "produto");
    historico.push(historico13);
    let historico14 = new Historico(14, clientes[2], produtos[1].getNome, pets[2], produtos[1].getValor, "22/01/2022", "17:00", "produto");
    historico.push(historico14);
    let historico15 = new Historico(15, clientes[6], produtos[2].getNome, pets[6], produtos[2].getValor, "23/01/2022", "18:00", "produto");
    historico.push(historico15);
    let historico16 = new Historico(16, clientes[6], produtos[3].getNome, pets[6], produtos[3].getValor, "24/01/2022", "19:00", "produto");
    historico.push(historico16);
    let historico17 = new Historico(17, clientes[8], produtos[4].getNome, pets[8], produtos[4].getValor, "25/01/2022", "20:00", "produto");
    historico.push(historico17);
    let historico18 = new Historico(18, clientes[10], produtos[5].getNome, pets[10], produtos[5].getValor, "26/01/2022", "21:00", "produto");
    historico.push(historico18); 
    let historico19 = new Historico(19, clientes[10], produtos[1].getNome, pets[10], produtos[1].getValor, "26/01/2022", "21:00", "produto");
    historico.push(historico19);
    let historico20 = new Historico(20, clientes[10], produtos[9].getNome, pets[10], produtos[9].getValor, "27/01/2022", "10:00", "produto");
    historico.push(historico20);
    let historico21 = new Historico(21, clientes[0], servicos[0].getNome, pets[0], servicos[0].getValor, "01/01/2022", "10:00", "servico");
    historico.push(historico21);
    let historico22 = new Historico(22, clientes[1], servicos[1].getNome, pets[1], servicos[1].getValor, "02/01/2022", "11:00", "servico");
    historico.push(historico22);
    let historico23 = new Historico(23, clientes[2], servicos[2].getNome, pets[2], servicos[2].getValor, "03/01/2022", "11:00", "servico");
    historico.push(historico23);
    let historico24 = new Historico(24, clientes[3], servicos[3].getNome, pets[3], servicos[3].getValor, "04/01/2022", "11:00", "servico");
    historico.push(historico24);
    let historico25 = new Historico(25, clientes[4], servicos[4].getNome, pets[4], servicos[4].getValor, "05/01/2022", "11:00", "servico");
    historico.push(historico25);
    let historico26 = new Historico(26, clientes[5], servicos[5].getNome, pets[5], servicos[5].getValor, "06/01/2022", "11:00", "servico");
    historico.push(historico26);
    let historico27 = new Historico(27, clientes[6], servicos[6].getNome, pets[6], servicos[6].getValor, "07/01/2022", "11:00", "servico");
    historico.push(historico27);
    let historico28 = new Historico(28, clientes[7], servicos[7].getNome, pets[7], servicos[7].getValor, "08/01/2022", "11:00", "servico");
    historico.push(historico28);
    let historico29 = new Historico(29, clientes[8], servicos[8].getNome, pets[8], servicos[8].getValor, "09/01/2022", "11:00", "servico");
    historico.push(historico29);
    let historico30 = new Historico(30, clientes[9], servicos[9].getNome, pets[9], servicos[9].getValor, "10/01/2022", "11:00", "servico");
    historico.push(historico30);
    let historico31 = new Historico(31, clientes[10], servicos[10].getNome, pets[10], servicos[10].getValor, "11/01/2022", "11:00", "servico");
    historico.push(historico31);
    let historico32 = new Historico(32, clientes[11], servicos[11].getNome, pets[11], servicos[11].getValor, "12/01/2022", "11:00", "servico");
    historico.push(historico32);
    let historico33 = new Historico(33, clientes[10], servicos[7].getNome, pets[10], servicos[7].getValor, "13/01/2022", "11:00", "servico");
    historico.push(historico33);
    let historico34 = new Historico(34, clientes[9], servicos[2].getNome, pets[9], servicos[2].getValor, "14/01/2022", "11:00", "servico");
    historico.push(historico34);
    let historico35 = new Historico(35, clientes[8], servicos[5].getNome, pets[8], servicos[5].getValor, "15/01/2022", "11:00", "servico");
    historico.push(historico35);
    let historico36 = new Historico(36, clientes[5], servicos[5].getNome, pets[5], servicos[5].getValor, "15/01/2022", "11:00", "servico");
    historico.push(historico36);
}
